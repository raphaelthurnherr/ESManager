...
#define TOPIC_MGR  "ESMGR"			// Canal de n�gociation eduspider / Algoid, toujours online
...
#define NEGOC_ES_RENAME	0x01
#define NEGOC_MGR_JOIN	0x02
#define NEGOC_MGR_LEAVE	0x03
#define NEGOC_TX_CHANNEL 0x04
#define NEGOC_ADD_RX_CHANNEL 0x05
#define NEGOC_REM_RX_CHANNEL 0x06
